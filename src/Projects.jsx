    ...
    <>
      <main className={props.darkMode ? "dark" : ""}>
        <div className="projects-div">
          <h3>Projects</h3>
          <p>A small display of my abilities.</p>
        </div>
        <span className="grid">
          <div className="projects-grid">
            <a
              className="main-site"
              href="https://sports-hub-demo.netlify.app/"
            >
              <div className="grid-div">
                ...
                <p>
                  A demonstration of React and the integration of multiple APIs,
                  showcasing live sporting events, including games, matches, and
                  scores.
                </p>
              </div>
            </a>

            <a href="https://exercise-substitute.netlify.app///">
              <div className="grid-div">
                <span className="link">🔗</span>
                <h1>Exercise Substitute </h1>
                <span className="skills-p">
                  <ul>
                    <li>React</li>
                    <li>TypeScript</li>
                    <li>Tailwind CSS</li>
                ...
                <p>
                  A demonstration of React and API integration, facilitating
                  substitute and exercise selection for various muscle groups.
                </p>
              </div>
            </a>

            <a href="https://furniture-plus.netlify.app/">
              <div className="grid-div">
                <span className="link">🔗</span>
                <h1>E-commerce Furniture Plus</h1>
                <span className="skills-p">
                  <ul>
                    <li>React.js</li>
                    <li>JavaScript</li>
                ...
                <p>
                  An e-commerce landing page developed using React. A Display of
                  the fundamentals.
                </p>
              </div>
            </a>
