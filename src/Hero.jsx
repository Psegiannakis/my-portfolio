  ...
  return (
    <>
      <div className="hero-main">
        <h1>
          Hi. I'm <span className="color-text">Eleftherios Psegiannakis.</span>
        </h1>
        <h3>
        ...
        <p className="para">
          ...
          captivating digital experiences. With a focus on design and expertise
          in the latest development tools, I'm dedicated to building
